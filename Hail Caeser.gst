...
<gameSystem id="856f-b39f-b616-471f" name="Hail Caeser" revision="3" battleScribeVersion="2.03" authorName="Michael Oke" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
  ...
  <categoryEntries>
    ...
    <categoryEntry id="3c9f-a578-5486-937c" name="Legion" hidden="false"/>
    <categoryEntry id="d41e-fe40-6a03-402c" name="Hirdsmen" hidden="false"/>
    <categoryEntry id="b533-6a8f-6ab9-ad87" name="Bondi" hidden="false"/>
    <categoryEntry id="ae43-4cce-7624-b0c8" name="Infantry (Core)" hidden="false"/>
    <categoryEntry id="bfd0-92ac-e33a-d603" name="Huscarl" hidden="false"/>
    <categoryEntry id="9ad9-492c-0f80-2eac" name="Archer" hidden="false"/>
    <categoryEntry id="48d3-34b8-1d1c-7118" name="Light Infantry" hidden="false"/>
